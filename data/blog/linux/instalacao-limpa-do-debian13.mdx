...
- [Introdução](#introdução)
  - [Vídeo aula](#vídeo-aula)
- [Instalação](#instalação)
  - [Particionamento de disco](#particionamento-de-disco)
    - [Instalação em partição única (Assistido - usar o disco inteiro)](#instalação-em-partição-única-assistido---usar-o-disco-inteiro)
    - [Instalação com múltiplas partições (Manual)](#instalação-com-múltiplas-partições-manual)
    - [Usando LVM (Logical Volume Manager)](#usando-lvm-logical-volume-manager)
    - [Boas práticas](#boas-práticas)
    - [Para o tutorial...](#para-o-tutorial)
  - [Continuando a instalação](#continuando-a-instalação)
- [Pós Instalação](#pós-instalação)
  - [Configuração do NTP](#configuração-do-ntp)
  - [Pacotes Padrão](#pacotes-padrão)
    - [Ajustes no Bash](#ajustes-no-bash)
