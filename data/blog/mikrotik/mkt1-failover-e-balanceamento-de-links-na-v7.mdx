---
title: 'Configuração FailOver e LoadBalance no Mikrotik v7 - Parte I' 
date: '2025-03-07'
tags: ['mikrotik']
draft: false
...
## Introdução
Neste artigo, vamos abordar duas das técnicas mais importantes e utilizadas para garantir alta disponibilidade e desempenho em conexões WAN: o **failover recursivo** e o **balanceamento de carga via PCC** (Per Connection Classifier).
