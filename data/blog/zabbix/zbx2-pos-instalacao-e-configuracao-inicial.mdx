...
Com os comandos acima, teremos o Certbot instalado. Antes de emitirmos o certificado, garanta que o parâmetro *server_name* 
...
Também não queremos que o usuário Admin fique com a senha padrão. Para alteramos, navegue até *Usuários -> Usuários* no menu 
lateral esquerdo.
...
Clique no usuário *Admin* e então clique no botão **Alterar senha**. Preencha com a nova senha e clique no botão **Atualizar** 
...
de configuração nos hosts. E se você pretende usar um *Grafana* depois, você irá me agradecer por já te fazer pensar em 
...
grupos, navegue até *Dados coletados -> Grupos de Hosts*.
...
Para isso, navegue até *Administração -> Geral -> Outros* e altere a opção *Modo padrão de inventário de host* para **Automático**
...
Depois faça upload das imagens no diretório *rebranding*, você pode fazer via SCP ou usar algum utilitário gráfico, 
como o WinSCP.
