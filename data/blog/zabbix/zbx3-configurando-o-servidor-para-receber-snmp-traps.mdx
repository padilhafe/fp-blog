...
Vamos ajustar a community SNMP no nosso arquivo de `snmptrap.conf`, altere _public_ para o padrão de community que utiliza na sua rede:
...
Vamos ajustar o arquivo de serviço do `snmptrapd` para usar o usuário _root_ e ajustar para o SNMP carregar as MIBs na inicialização:
