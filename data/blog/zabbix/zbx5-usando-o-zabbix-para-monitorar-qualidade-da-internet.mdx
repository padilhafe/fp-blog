...
- [Primeiro Script: Monitoramento do Tempo de Resposta (ICMP)](#primeiro-script-monitoramento-do-tempo-de-resposta-icmp)
  - [O problema com o ping tradicional](#o-problema-com-o-ping-tradicional)
  - [Processando a saída](#processando-a-saída)
  - [Antes de começar](#antes-de-começar)
- [Criando o Script Bash de monitoramento ICMP para o Zabbix consumir](#criando-o-script-bash-de-monitoramento-icmp-para-o-zabbix-consumir)
...
Para isso, vá até _Administração -> Geral -> Timeouts_ e aumente o timeout da opção **Monitoramento externo** de 3 para 10 segundos.
